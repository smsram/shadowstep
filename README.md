...
[![Install from Microsoft Edge Add-ons](https://img.shields.io/badge/Microsoft_Edge_Add--ons-Install_Now-0078D4?logo=microsoftedge&logoColor=white)](https://microsoftedge.microsoft.com/addons/detail/shadowstep/iehelgmcldkldibjabnngfgfehegomgh)
...
### Option A: Direct Store Install (Recommended)
Install ShadowStep directly from the official Microsoft Edge Add-ons Store:

- [Install ShadowStep from Microsoft Edge Add-ons](https://microsoftedge.microsoft.com/addons/detail/shadowstep/iehelgmcldkldibjabnngfgfehegomgh)

### Option B: Build Unpacked Extension from Source Code
